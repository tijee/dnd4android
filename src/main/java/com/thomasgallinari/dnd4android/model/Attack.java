...
public class Attack implements Serializable, Comparable<Attack> {
    ...
    /**
     * @param attackAbil the attackAbil to set
     */
    ...
    /**
     * @param attackEnh the attackEnh to set
     */
    ...
    /**
     * @param attackFeat the attackFeat to set
     */
    ...
    /**
     * @param attackMisc the attackMisc to set
     */
    ...
    /**
     * @param attackProf the attackProf to set
     */
    ...
    /**
     * @param damageAbil the damageAbil to set
     */
    ...
    /**
     * @param damageEnh the damageEnh to set
     */
    ...
    /**
     * @param damageFeat the damageFeat to set
     */
    ...
    /**
     * @param damageMisc the damageMisc to set
     */
