...
public class SkillsActivity extends OrmLiteBaseListActivity<DatabaseHelper>
    ...
    private static final String BUNDLE_SELECTED_SKILL = "selected_skill";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mSelectedSkill = (Skill) savedInstanceState.get(BUNDLE_SELECTED_SKILL);
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        outState.putSerializable(BUNDLE_SELECTED_SKILL, mSelectedSkill);
    }
